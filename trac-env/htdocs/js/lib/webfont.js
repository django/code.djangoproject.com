...
(function (window, document, undefined) {
    ...
    function C(a) {
        ...
        a &&
            ...
            a[4] !== l &&
                a[4] &&
                (f = /^[0-9]+$/.test(a[4]) ? parseInt(a[4], 10) : a[4]));
    ...
    function la(a, b, c, d, f, g, e, h) {
        ...
        for (var k in R)
            R.hasOwnProperty(k) &&
                (P(a, new J(R[k], K(this.q))),
                (this.F[R[k]] = a.s.offsetWidth));
        a.remove();
    }
    ...
    function na(a) {
        var b = a.A.s.offsetWidth,
            c = a.B.s.offsetWidth;
        (b === a.F.serif && c === a.F["sans-serif"]) || (a.j.U && oa(a, b, c))
            ? u() - a.xa >= a.T
                ? a.j.U &&
                  oa(a, b, c) &&
    ...
    T.prototype.ga = function (a) {
        ...
        x(
            b.m,
            [b.g.f(b.h, a.getName(), K(a).toString(), "active")],
            [
            ...
            (a.ba
                ? ((a = a.t),
                  x(
                      a.m,
                      [a.g.f(a.h, "active")],
                      [a.g.f(a.h, "loading"), a.g.f(a.h, "inactive")],
                  ),
                  N(a, "active"))
                : L(a.t));
    }
        ...
        for (var a = this.p.length, b = 0; b < a; b++) {
            ...
            if (2 <= c.length) {
                ...
                3 == c.length &&
                    ...
                    (g = []),
                    (c = !c ? g : c.split(",")),
                    0 < c.length && (c = ua[c[0]]) && (this.J[d] = c));
            }
            this.J[d] || ((c = ua[d]) && (this.J[d] = c));
            for (c = 0; c < f.length; c += 1) this.$.push(new J(d, f[c]));
        }
    };
    function V(a, b) {
    ...
    V.prototype.X = function (a) {
        for (
            var b = this.c,
                c = new ra(this.e.api, y(b), this.e.text),
                d = this.e.families,
                f = d.length,
                g = 0;
            g < f;
    ...
    W.prototype.D = function (a) {
        return (
            y(this.c) +
            (this.e.api || "//f.fontdeck.com/s/css/js/") +
            (this.c.v.location.hostname || this.c.G.location.hostname) +
            "/" +
            a +
            ".js"
        );
    ...
    X.prototype.H = function (a, b) {
        var c = this.e.id,
            ...
            g = this;
        c
            ? (f.__webfonttypekitmodule__ || (f.__webfonttypekitmodule__ = {}),
              (f.__webfonttypekitmodule__[c] = function (c) {
    ...
    Y.prototype.D = function (a, b) {
        var c = y(this.c),
            d = (this.e.api || "fast.fonts.net/jsapi").replace(
                /^.*http(s?):(\/\/)?/,
                "",
            );
    ...
    q.WebFont ||
        ((q.WebFont = {}),
        (q.WebFont.load = t($.load, $)),
        q.WebFontConfig && $.load(q.WebFontConfig));
})(this, document);
